namespace K1vs.DotChat.Implementations.CoreSignalR
{
        ...
        where TContactMessage : IContactMessage<TChatUser>
    {
        ...
        protected IHubContext<TChatsHub, TChatsClient> ChatsHubContext { get; }
        protected IHubContext<TChatParticipantsHub, TChatParticipantsClient> ChatParticipantsHubContext { get; }
        protected IHubContext<TChatMessagesHub, TChatMessagesClient> ChatMessagesHubContext { get; }

        public SignalRNotificationSender(IHubContext<TChatsHub, TChatsClient> chatsHubContext, 
            IHubContext<TChatParticipantsHub, TChatParticipantsClient> chatParticipantsHubContext, 
            IHubContext<TChatMessagesHub, TChatMessagesClient> chatMessagesHubContext)
        {
            ChatsHubContext = chatsHubContext;
            ChatParticipantsHubContext = chatParticipantsHubContext;
            ChatMessagesHubContext = chatMessagesHubContext;
        }
