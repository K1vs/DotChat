namespace K1vs.DotChat.Commands.Participants
{
    ...
    public class ApplyToChatCommand: Command, IApplyToChatCommand
    {
        ...
        public ApplyToChatCommand(Guid initiatorUserId, Guid chatId, Guid userId, ChatParticipantType chatParticipantType, IReadOnlyList<string> styles = null) : base(initiatorUserId)
        {
            ChatId = chatId;
            UserId = userId;
