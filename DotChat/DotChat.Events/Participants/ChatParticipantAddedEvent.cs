namespace K1vs.DotChat.Events.Participants
{
    ...
    public class ChatParticipantAddedEvent: Event, IChatParticipantAddedEvent
    {
        ...
        public ChatParticipantAddedEvent(Guid initiatorUserId, Guid chatId, IChatParticipant participant, IParticipationModificationResult participationModificationResult) : base(initiatorUserId)
        {
            ChatId = chatId;
